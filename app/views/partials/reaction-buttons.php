<ul class="flex justify-around">
    <li class="w-6 h-6 rounded-full hover:bg-blue-200 dark:hover:bg-blue-500 flex justify-center items-center"><a href="">
    ...
    <li class="w-6 h-6 rounded-full hover:bg-green-200 dark:hover:bg-green-500 flex justify-center items-center"><a href="">
    ...
    <li class="w-6 h-6 rounded-full hover:bg-red-200 dark:hover:bg-red-500 flex justify-center items-center"><a href="">
