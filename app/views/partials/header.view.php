...
<div class="h-10 flex justify-between place-items-center p-1">
    ...
    <a href="https://twitter.com/intent/follow?screen_name=reezyDev">
        <button class="px-4 py-2 text-gray-50 rounded-3xl mt-2 text-sm border border-gray-100 bg-gray-950 hover:bg-green-800 dark:bg-gray-100 dark:text-gray-950">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail-filled" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
<div class="h-2/5 p-1">
    ...
    <div class="w-3/4 mx-auto">
        <ul class="flex justify-between mt-5 bg-gray-100 dark:bg-gray-400 rounded">
            <li class="w-8 h-8 rounded hover:bg-gray-200 flex justify-center items-center"><a
                        href="https://www.linkedin.com/in/chiloanerk/" target="_blank">
            ...
            <li class="w-8 h-8 rounded hover:bg-gray-200 flex justify-center items-center"><a
                        href="https://twitter.com/intent/follow?screen_name=reezyDev" target="_blank" class="hover:font-bold">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-x" width="20"
                         height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none"
                         stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            ...
            <li class="w-8 h-8 rounded hover:bg-gray-200 flex justify-center items-center"><a
                        href="https://github.com/chiloanerk" target="_blank" class="hover:font-bold">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github" width="20"
                         height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none"
                         stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
